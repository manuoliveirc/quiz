    ...
    <div class ="card-body">
        ...
        <form action ="{{route ('dadosPagina1')}}" method ="POST">
            ...
            <div class ="form-group py-4">
                <label for="pergunta"> <h3 > <strong> Qual o verdadeiro nome por trás do herói?</strong> </h3> </label>
